...
INLINE KASYNC_IO_RESULT kudp_try_recv(kconnection* uc, result_callback result, buffer_callback buffer, void* arg)
{
    return kgl_selector_module.recvfrom(uc->st.selector, &uc->st, result, buffer, arg);
}
